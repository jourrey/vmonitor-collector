...
/**
 * @ClassName: DoLogCollectorInterface
 * @Description: TODO(日志收集者接口)
 * @author liuzheng03
 ...
 * @param <A>
 */
public interface DoLogCollectorInterface<C extends SpringCallLogInfo, A extends SpringAnswerLogInfo> extends CollectorInterface {
